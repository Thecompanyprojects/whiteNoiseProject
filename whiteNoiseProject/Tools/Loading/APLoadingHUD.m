...
#define instance [APLoadingHUD shareInstance]


@interface APLoadingHUD ()
...
@implementation APLoadingHUD

+ (instancetype) shareInstance{
    static APLoadingHUD* _instance = nil;
...
+ (UIView *)CreateLoadingViewWithFrame:(CGRect)frame{
    ...
    APLoadingView *loadingV = [[APLoadingView alloc]initWithFrame:CGRectMake(0, 0, hudWidth, hudWidth)];
